...
Ext.UpdateManager.defaults.indicatorText = '<div class="loading-indicator">U�?itavanje...</div>';
...
if(Ext.LoadMask){
    Ext.LoadMask.prototype.msg = "U�?itavanje...";
}
  ...
  Ext.apply(Ext.form.HtmlEditor.prototype, {
    ...
    buttonTips : {
      bold : {
        ...
        text: 'Podebljavanje ozna�?enog teksta.',
        cls: 'x-html-editor-tip'
      },
      italic : {
        title: 'Kurziv (Ctrl+I)',
        text: 'Pretvaranje ozna�?enog tekst u kurziv',
        cls: 'x-html-editor-tip'
      },
      underline : {
        title: 'Podcrtano (Ctrl+U)',
        text: 'Potcrtavanje ozna�?enog teksta',
        cls: 'x-html-editor-tip'
      },
      increasefontsize : {
        title: 'Povećanje teksta',
        text: 'Povećavanje veli�?ine fonta.',
        cls: 'x-html-editor-tip'
      },
      decreasefontsize : {
        title: 'Smanjivanje teksta',
        text: 'Smanjivanje veli�?ine fonta.',
        cls: 'x-html-editor-tip'
      },
      backcolor : {
        title: 'Boja ozna�?enog teksta',
        text: 'Promjena boje pozadine ozna�?enog teksta.',
        cls: 'x-html-editor-tip'
      },
      forecolor : {
        title: 'Boja fonta',
        text: 'Promjena boje ozna�?enog teksta.',
        cls: 'x-html-editor-tip'
      },
      justifyleft : {
      ...
      justifycenter : {
        ...
        text: 'Centriranje teksta u uređiva�?u teksta.',
        cls: 'x-html-editor-tip'
      },
      justifyright : {
      ...
      insertunorderedlist : {
        title: 'Ozna�?ena lista',
        text: 'Zapo�?injanje ozna�?ene liste.',
        cls: 'x-html-editor-tip'
      },
      insertorderedlist : {
        title: 'Numerirana lista',
        text: 'Zapo�?injanje numerirane liste.',
        cls: 'x-html-editor-tip'
      },
      createlink : {
        title: 'Hiperveza',
        text: 'Stvaranje hiperveze od ozna�?enog teksta.',
        cls: 'x-html-editor-tip'
      },
      sourceedit : {
        title: 'Uređivanje izvornog koda',
        text: 'Prebacivanje u na�?in rada za uređivanje izvornog koda.',
        cls: 'x-html-editor-tip'
      }
    }
  });
...
if(Ext.grid.GridView){
   Ext.apply(Ext.grid.GridView.prototype, {
      ...
      lockText     : "Zaklju�?aj stupac",
      unlockText   : "Otklju�?aj stupac",
      columnsText  : "Stupci"
   });
}
...
if(Ext.layout.BorderLayout.SplitRegion){
   Ext.apply(Ext.layout.BorderLayout.SplitRegion.prototype, {
      splitTip            : "Povuci za promjenu veli�?ine.",
      collapsibleSplitTip : "Povuci za promjenu veli�?ine. Dvostruki klik za skrivanje."
   });
}
